...
This web app: A flash card project where you get to dance every time you get a question right
...
- [ ] Cards have different visual styles such as color based on their category
  - Example categories you can use:
    ...
    - Subject: Computer Science: Python - concepts on solving technical interview questions
